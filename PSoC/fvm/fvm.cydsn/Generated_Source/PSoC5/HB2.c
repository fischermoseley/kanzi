...
*
* \funcusage
*  \snippet HB2_SUT.c usage_HB2_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet HB2_SUT.c usage_HB2_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet HB2_SUT.c usage_HB2_Read  
*******************************************************************************/
uint8 HB2_Read(void)
{
...
* preferred HB2_Read() API because the 
* HB2_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet HB2_SUT.c usage_HB2_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: HB2_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use HB2_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - HB2_0_INTR       (First pin in the list)
    *  - HB2_1_INTR       (Second pin in the list)
    *  - ...
    *  - HB2_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet HB2_SUT.c usage_HB2_SetInterruptMode
    *******************************************************************************/
    void HB2_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & HB2_0_INTR) != 0u) 
		{ 
			 HB2_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet HB2_SUT.c usage_HB2_ClearInterrupt
    *******************************************************************************/
