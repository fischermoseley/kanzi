...
//There used to be hardware-specific definitions here, but 32 was the default if those failed
...
{
public:
	boolean begin(uint8_t deviceAddress = BNO080_DEFAULT_ADDRESS, uint8_t intPin = 255); //By default use the default I2C addres, and use Wire port, and don't declare an INT pin
